...
/** Append tracks to the playlist.
 ...
 @note This operation is asynchronous on the server, it can take a couple of seconds for your changes to propagate everywhere after this operatio fn has started.
